...
from fixtures.bootstrap_fixtures import *  # noqa: F403
from fixtures.bootstrap_fixtures import collect_sse_messages


@pytest.fixture(autouse=True)
def mock_strategy_factory(mock_node):
    mock_node.metadata.labels["chutes/tee"] = "true"
    mock_node.metadata.labels["chutes/external-ip"] = "192.168.1.100"
    yield mock_node
