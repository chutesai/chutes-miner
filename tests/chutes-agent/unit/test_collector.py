...
async def test_collect_all_resources_success(
    mock_namespaces, resource_collector, sample_pod, sample_deployment, sample_service
):
...
async def test_collect_all_resources_namespace_error(
    mock_namespaces, resource_collector, sample_pod
):
