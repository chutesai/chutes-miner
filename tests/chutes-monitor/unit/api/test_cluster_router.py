...
async def test_register_cluster_success(
    mock_cluster_monitor, test_client, create_cluster_request_data, mock_db_session
):
...
@pytest.mark.asyncio
async def test_register_cluster_failure(
...
@pytest.mark.asyncio
async def test_receive_resource_update_success(
    mock_redis_client, test_client, test_resource_update_request
):
